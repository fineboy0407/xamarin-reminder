...
namespace ReminderXamarin.Pages
{
    /// <inheritdoc />
    /// <summary>
    /// Page contains to-do list of high-priority to-do items.
    /// </summary>
    [XamlCompilation(XamlCompilationOptions.Compile)]
    public partial class ToDoHighPriorityPage : ContentPage
    {
        public ToDoHighPriorityPage()
        {
            InitializeComponent();
        }
        ...
        {
            await Navigation.PushAsync(new ToDoCreatePage(ToDoPriority.High));
        }
    }
}